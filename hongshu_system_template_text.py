...
我会每次给你一个主题，同时会给你参考案例，请你根据主题和案例，基于以上规则，生成相对应的小红书文案。

{parser_instructions}
"""

user_template_text = """
以{theme}为主题，同时参考我给的案例，案例前后以###包围，以{manner_speaking}的语气，生成相对应的小红书文案。
###参考的主题{Reference_Topic}，## 参考的正文：{Reference_Text}###
"""